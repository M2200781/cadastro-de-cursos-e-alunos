#Importando dependencias Tkinter
...
def alunos():
    ...
    def novo_aluno():
        ...
        #Verificando se caso o campo esteja vazio
        for i in lista:
            if i == '':
    ...
    def update_aluno():
        ...
        try:
            ...
            botao_update = Button(frame_detalhes, command=update, anchor=CENTER, text="Salvar Atualização".upper(), width=9, compound=CENTER, overrelief=RIDGE, font=('Ivy 7 bold'), bg=co3, fg=co1)
    ...
    data_nascimento = DateEntry(frame_detalhes, width=18, background='darkblue', foreground='white', borderwidth=2, date_pattern='dd/mm/yyyy')
    ...
    def escolher_imagem():
        ...
        botao_carregar['text'] = 'Mudar Foto'.upper()
    ...
    #Faltando uma função para procura
    ...
    botao_procurar = Button(frame_detalhes, anchor=CENTER, text="Procurar".upper(), width=9, compound=CENTER, overrelief=RIDGE, font=('Ivy 7 bold'), bg=co1, fg=co0)
    botao_procurar.place(x=757, y=35)
    
    
    #Botões-------------------------------------------------------------------
    
    botao_salvar = Button(frame_detalhes, command=novo_aluno, anchor=CENTER, text="Salvar".upper(), width=9, compound=CENTER, overrelief=RIDGE, font=('Ivy 7 bold'), bg=co3, fg=co1)
    botao_salvar.place(x=627, y=110)
    
    botao_atualizar = Button(frame_detalhes, command=update_aluno, anchor=CENTER, text="Atualizar".upper(), width=9, compound=CENTER, overrelief=RIDGE, font=('Ivy 7 bold'), bg=co6, fg=co1)
    botao_atualizar.place(x=627, y=135)
    
    botao_deletar = Button(frame_detalhes, command=delete_aluno, anchor=CENTER, text="Deletar".upper(), width=9, compound=CENTER, overrelief=RIDGE, font=('Ivy 7 bold'), bg=co7, fg=co1)
    botao_deletar.place(x=627, y=160)
    
    botao_ver = Button(frame_detalhes, command=ver_aluno, anchor=CENTER, text="Ver".upper(), width=9, compound=CENTER, overrelief=RIDGE, font=('Ivy 7 bold'), bg=co1, fg=co0)
    botao_ver.place(x=727, y=160)
    
    
    #Tabela mostrar alunos
    ...
    def mostrar_alunos():
        ...
        hsb = ttk.Scrollbar(frame_tabela, orient='horizontal', command=tree_aluno.yview)
...
def adicionar():
    ...
    def update_curso():
        try:
            ...
            messagebox.showerror('Erro', 'Selecicione um dos cursos na tabela')
    ...
    def mostrar_cursos():
        ...
        #Horizontal Scrollbar
        hsb = ttk.Scrollbar(frame_tabela_curso, orient='horizontal', command=tree_curso.yview)
    ...
    #Linha separatória vertical tabela----------------------------------------
    ...
    def delete_turma():
        try:
            ...
            messagebox.showerror('Erro', 'Selecicione uma das turmaas na tabela')
    ...
    data_inicio = DateEntry(frame_detalhes, width=10, background='darkblue', foreground='white', borderwidth=2, date_pattern='dd/mm/yyyy')
    ...
    def mostrar_turmas():
        ...
        #Horizontal Scrollbar
        hsb = ttk.Scrollbar(frame_tabela_turma, orient='horizontal', command=tree_turma.yview)
